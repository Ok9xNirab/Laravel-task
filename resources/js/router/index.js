    ...
    children: [
      {
        ...
        name: 'Posts',
        meta: { title: 'Posts', icon: 'form', noCache: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/posts/categories'),
        name: 'Categories',
        meta: { title: 'Post Categories', icon: 'example', noCache: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        name: 'CreatePost',
        meta: { title: 'Create Post', icon: 'form', noCache: true },
      },
    ],
    hidden: true,
  },
    ...
    children: [
      {
        ...
        name: 'EditPost',
        meta: { title: 'Edit Post', icon: 'form', noCache: true },
      },
    ],
    hidden: true,
  },
